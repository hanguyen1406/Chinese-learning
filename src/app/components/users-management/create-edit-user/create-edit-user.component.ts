...
export class CreateEditUserComponent implements OnInit {
  ...
  formCreateEditAddress : FormGroup = new FormGroup({
    "country" : new FormControl("United States", null),
  ...
  ngOnInit(): void {
    ...
    // this.typeRanksService.getAll().subscribe((typeRanks: any[]) => { 
    ...
    // this.scientificAreaService.getAll().subscribe((scientificAreas: any[]) => { 
  ...
  saveRank(){
    ...
    //     if (!this.newListRanks.some((rank: any) => (rank.scientificArea.name == this.formCreateEditRanks.value.scientificArea.name) &&
  ...
  refreshRanksTable(){
    // this.rankService.getByUsername(this.formCreateEditUser.value.username).subscribe((rank: any[]) => { 
